Public Class frm_cust_a202713
    Private Sub frm_cust_a202713_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim mysql As String = "SELECT * FROM TBL_Customer_A202713"
        Dim mydatatable As New DataTable
        Dim myreader As New OleDb.OleDbDataAdapter(mysql, myconnection)
        myreader.Fill(mydatatable)
        grd_cust.DataSource = mydatatable
    End Sub

    Private Sub btn_mng_Click(sender As Object, e As EventArgs) Handles btn_mng.Click
        frm_managecustomer_a202713.Show()
        Me.Hide()
